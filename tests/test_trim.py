"""
Test package of the varana.trim module
"""
import unittest
import numpy as np
...
class TrimTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.lc_trim_inverse_filename = (
            path + r'/test_data/synthetic_lc_sigma_clipping_inverse.dat')
        self.lc_manual_trim_filename = (
            path + r'/test_data/synthetic_lc_manual_trim.dat')
